...
//Khi API đang chạy mà phát sinh exception, Spring sẽ tìm trong các class có @RestControllerAdvice xem có method nào bắt đúng loại lỗi đó không.
// Nếu có, luồng xử lý sẽ “chuyển” vào method tương ứng trong GlobalException.
public class GlobalException {
    //Thay vì mỗi Controller đều phải viết try-catch, khi có lỗi xảy ra, Spring sẽ tự chuyển lỗi đến class GlobalException, sau đó trả về JSON có cùng cấu trúc:

    //@RestControllerAdvice có hai nhiệm vụ:
    //Theo dõi lỗi xảy ra trong tất cả Controller.
    //Biến object trả về thành JSON giống như @RestController
    /**
    ...
    // Khi một trong ba exception này xảy ra, hãy gọi method handleValidationException().
    ...
    // cái này dành cho swagger (ApiResponses)
    @ApiResponses(value = {
